...
public class Dfs {
    ...
    public Dfs(MainWindow mainWindow, Grid grid, int startX, int startY, boolean diagonalSearch) {
        ...
        nodes.push(new Node(startX, startY, null));
    ...
    public int search() {
        ...
        if (!nodes.isEmpty()) {
            ...
            if (allowed(tmp.getX() - 1, tmp.getY())) {
                nodes.push(new Node(tmp.getX() - 1, tmp.getY(), tmp));
            ...
            if (allowed(tmp.getX(), tmp.getY() - 1)) {
                nodes.push(new Node(tmp.getX(), tmp.getY() - 1, tmp));
    ...
    public int searchWithDiagonals() {
        ...
        if (!nodes.isEmpty()) {
            ...
            if (allowed(tmp.getX() - 1, tmp.getY() - 1)) {
                nodes.push(new Node(tmp.getX() - 1, tmp.getY() - 1, tmp));
